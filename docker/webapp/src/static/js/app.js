!function(t, e) {
    ...
    w.extend({
        ...
        isPlainObject: function(t) {
            var e, n;
            return !(!t || "[object Object]" !== u.call(t)) && (!(e = s(t)) || "function" == typeof (n = h.call(e, "constructor") && e.constructor) && d.call(n) === f)
        },
    ...
    var k = function(t) {
        var e, n, i, s, o, r, a, l, c, u, h, d, f, p, m, g, v, y, _, b = "sizzle" + 1 * new Date, w = t.document, D = 0, x = 0, k = rt(), C = rt(), S = rt(), T = function(t, e) {
            return t === e && (h = !0),
            0
            ...
            for (var n = 0, i = t.length; n < i; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, L = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", j = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", Y = "\\[" + j + "*(" + H + ")(?:" + j + "*([*^$|!~]?=)" + j + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + j + "*\\]", $ = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + Y + ")*)|.*)\\)|)", R = new RegExp(j + "+","g"), W = new RegExp("^" + j + "+|((?:^|[^\\\\])(?:\\\\.)*)" + j + "+$","g"), q = new RegExp("^" + j + "*," + j + "*"), F = new RegExp("^" + j + "*([>+~]|" + j + ")" + j + "*"), U = new RegExp("=" + j + "*([^\\]'\"]*?)" + j + "*\\]","g"), B = new RegExp($), V = new RegExp("^" + H + "$"), G = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
            TAG: new RegExp("^(" + H + "|[*])"),
            ATTR: new RegExp("^" + Y),
        ...
        }, z = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, Q = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, X = /[+~]/, J = new RegExp("\\\\([\\da-f]{1,6}" + j + "?|(" + j + ")|.)","ig"), tt = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        function ot(t, e, i, s) {
            var o, a, c, u, h, p, v, y = e && e.ownerDocument, D = e ? e.nodeType : 9;
            if (i = i || [],
            ...
            m)) {
                ...
                if (n.qsa && !S[t + " "] && (!g || !g.test(t))) {
                    if (1 !== D)
                        ...
                        for ((u = e.getAttribute("id")) ? u = u.replace(et, nt) : e.setAttribute("id", u = b),
                        a = (p = r(t)).length; a--; )
                            p[a] = "#" + u + " " + vt(p[a]);
                        v = p.join(","),
        ...
        d = ot.setDocument = function(t) {
            ...
            _ = e || Q.test(p.contains) ? function(t, e) {
            ...
            : function(t, e) {
                ...
                if (!s || !o)
                    return t === f ? -1 : e === f ? 1 : s ? -1 : o ? 1 : u ? P(u, t) - P(u, e) : 0;
                if (s === o)
                    return ut(t, e);
        ...
        (i = ot.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, n = !t[6] && t[2];
                    return G.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && B.test(n) && (e = r(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e),
                    t[2] = n.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(t, e, n, i, s) {
                    ...
                    : function(e, n, l) {
                        var c, u, h, d, f, p, m = o !== r ? "nextSibling" : "previousSibling", g = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, _ = !1;
                        if (g) {
                            if (o) {
                                for (; m; ) {
                                    for (d = e; d = d[m]; )
                            ...
                            r && y) {
                                for (_ = (f = (c = (u = (h = (d = g)[b] || (d[b] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === D && c[1]) && c[2],
                                d = f && g.childNodes[f]; d = ++f && d && d[m] || (_ = f = 0) || p.pop(); )
                                    if (1 === d.nodeType && ++_ && d === e) {
                                        u[t] = [D, f, _];
                                        break
                                    }
                            } else if (y && (_ = f = (c = (u = (h = (d = e)[b] || (d[b] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === D && c[1]),
                            !1 === _)
                                for (; (d = ++f && d && d[m] || (_ = f = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++_ || (y && ((u = (h = d[b] || (d[b] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] = [D, _]),
                                d !== e)); )
                                    ;
                            return (_ -= s) === i || _ % i == 0 && _ / i >= 0
                        }
                    }
                },
                PSEUDO: function(t, e) {
                    var n, s = i.pseudos[t] || i.setFilters[t.toLowerCase()] || ot.error("unsupported pseudo: " + t);
                    return s[b] ? s(e) : s.length > 1 ? (n = [t, t, "", e],
            ...
            pseudos: {
                not: at(function(t) {
                    var e = []
                      , n = []
                      , i = a(t.replace(W, "$1"));
                    return i[b] ? at(function(t, e, n, s) {
        ...
        function yt(t, e, n) {
            ...
            : function(e, n, l) {
                ...
                if (l) {
                    ...
                    for (; e = e[i]; )
                        if (1 === e.nodeType || r)
                            if (u = (h = e[b] || (e[b] = {}))[e.uniqueID] || (h[e.uniqueID] = {}),
                            s && s === e.nodeName.toLowerCase())
                                e = e[i] || e;
                            else {
                                if ((c = u[o]) && c[0] === D && c[1] === a)
                                    return d[2] = c[2];
                                if (u[o] = d,
                                d[2] = t(e, n, l))
                                    return !0
        ...
        function wt(t, e, n, i, s, o) {
            ...
            s && !s[b] && (s = wt(s, o)),
            at(function(o, r, a, l) {
                var c, u, h, d = [], f = [], p = r.length, m = o || function(t, e, n) {
                    for (var i = 0, s = e.length; i < s; i++)
                        ot(t, e[i], n);
                    return n
                }(e || "*", a.nodeType ? [a] : a, []), g = !t || !o && e ? m : bt(m, d, t, a, l), v = n ? s || (o ? t : p || i) ? [] : r : g;
                if (n && n(g, v, a, l),
                i)
                    for (c = bt(v, f),
                    i(c, [], a, l),
                ...
                if (o) {
                    if (s || t) {
                        ...
                        for (u = v.length; u--; )
                            (h = v[u]) && (c = s ? P(o, h) : d[u]) > -1 && (o[c] = !(r[c] = h))
                    }
                } else
                    v = bt(v === r ? v.splice(p, v.length) : v),
                    s ? s(null, r, v, l) : I.apply(r, v)
            })
        }
        function Dt(t) {
            for (var e, n, s, o = t.length, r = i.relative[t[0].type], a = r || i.relative[" "], l = r ? 1 : 0, u = yt(function(t) {
                return t === e
            }, a, !0), h = yt(function(t) {
                return P(e, t) > -1
        ...
        r = ot.tokenize = function(t, e) {
            var n, s, o, r, a, l, c, u = C[t + " "];
            if (u)
                return e ? 0 : u.slice(0);
            for (a = t,
            l = [],
            c = i.preFilter; a; ) {
                for (r in n && !(s = q.exec(a)) || (s && (a = a.slice(s[0].length) || a),
                l.push(o = [])),
                n = !1,
                ...
                a = a.slice(n.length)),
                i.filter)
                    !(s = G[r].exec(a)) || c[r] && !(s = c[r](s)) || (n = s.shift(),
                    o.push({
                        value: n,
                        type: r,
                        matches: s
        ...
        a = ot.compile = function(t, e) {
            var n, s, o, a, l, u, h = [], p = [], g = S[t + " "];
            if (!g) {
                for (e || (e = r(t)),
                n = e.length; n--; )
                    (g = Dt(e[n]))[b] ? h.push(g) : p.push(g);
                (g = S(t, (s = p,
                a = (o = h).length > 0,
                l = s.length > 0,
                u = function(t, e, n, r, u) {
                    var h, p, g, v = 0, y = "0", _ = t && [], b = [], w = c, x = t || l && i.find.TAG("*", u), k = D += null == w ? 1 : Math.random() || .1, C = x.length;
                    for (u && (c = e === f || e || u); y !== C && null != (h = x[y]); y++) {
                        if (l && h) {
                            for (p = 0,
                    ...
                    a && y !== v) {
                        ...
                        if (t) {
                            if (v > 0)
                                for (; y--; )
                                    _[y] || b[y] || (b[y] = M.call(r));
                            b = bt(b)
                        }
                        I.apply(r, b),
                        u && !t && b.length > 0 && v + o.length > 1 && ot.uniqueSort(r)
                    }
                    return u && (D = k,
                    c = w),
                    _
        ...
        l = ot.select = function(t, e, n, s) {
            var o, l, c, u, h, d = "function" == typeof t && t, f = !s && r(t = d.selector || t);
            if (n = n || [],
            1 === f.length) {
    ...
    w.Callbacks = function(t) {
        ...
        n) : w.extend({}, t);
        var i, s, o, r, a = [], l = [], c = -1, u = function() {
            for (r = r || t.once,
            o = i = !0; l.length; c = -1)
            ...
            add: function() {
                ...
                function e(n) {
                    w.each(n, function(n, i) {
                        m(i) ? t.unique && h.has(i) || a.push(i) : i && i.length && "string" !== _(i) && e(i)
                    })
                }(arguments),
                s && !i && u()),
                this
              ...
              , s = {
                ...
                then: function(e, i, s) {
                            ...
                            var a = this
                              ...
                              , c = function() {
                                ...
                                if (!(e < o)) {
                                    ...
                                    m(c) ? s ? c.call(t, r(o, n, H, s), r(o, n, Y, s)) : (o++,
                                    c.call(t, r(o, n, H, s), r(o, n, Y, s), r(o, n, H, n.notifyWith))) : (i !== H && (a = void 0,
                                    l = [t]),
                                    (s || n.resolveWith)(a, l))
                                }
                            }
                    ...
                    return w.Deferred(function(t) {
                        n[0][3].add(r(0, t, m(s) ? s : H, t.notifyWith)),
                        n[1][3].add(r(0, t, m(e) ? e : H)),
                        n[2][3].add(r(0, t, m(i) ? i : Y))
                    }).promise()
                },
                promise: function(t) {
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                ...
                1 === o.nodeType && !Q.get(o, "hasDataAttrs"))) {
                    for (n = r.length; n--; )
                        r[n] && 0 === (i = r[n].name).indexOf("data-") && (i = G(i.slice(5)),
                        tt(o, i, s[i]));
    ...
    var at = {};
    function lt(t, e) {
        for (var n, i, s, o, r, a, l, c = [], u = 0, h = t.length; u < h; u++)
            (i = t[u]).style && (n = i.style.display,
            e ? ("none" === n && (c[u] = Q.get(i, "display") || null,
            c[u] || (i.style.display = "")),
            "" === i.style.display && st(i) && (c[u] = (o = void 0,
            r = void 0,
            void 0,
            l = void 0,
            r = (s = i).ownerDocument,
    ...
    w.event = {
        ...
        add: function(t, e, n, i, s) {
            var o, r, a, l, c, u, h, d, f, p, m, g = Q.get(t);
            if (g)
                for (n.handler && (n = (o = n).handler,
                s = o.selector),
                s && w.find.matchesSelector(_t, s),
                ...
                c = (e = (e || "").match(j) || [""]).length; c--; )
                    ...
                    h.setup && !1 !== h.setup.call(t, i, p, r) || t.addEventListener && t.addEventListener(f, r)),
        ...
        remove: function(t, e, n, i, s) {
            var o, r, a, l, c, u, h, d, f, p, m, g = Q.hasData(t) && Q.get(t);
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(j) || [""]).length; c--; )
                    ...
                    f) {
                        ...
                        r = o = d.length; o--; )
                            u = d[o],
                            !s && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(o, 1),
                            u.selector && d.delegateCount--,
                            h.remove && h.remove.call(t, u));
                        r && !d.length && (h.teardown && !1 !== h.teardown.call(t, p, g.handle) || w.removeEvent(t, f, g.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(t) {
            var e, n, i, s, o, r, a = w.event.fix(t), l = new Array(arguments.length), c = (Q.get(this, "events") || {})[a.type] || [], u = w.event.special[a.type] || {};
            for (l[0] = a,
    ...
    w.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? xt : kt,
    ...
    function Lt(t, e, n, i) {
        e = r.apply([], e);
        var s, o, a, l, c, u, h = 0, d = t.length, f = d - 1, g = e[0], v = m(g);
        ...
        o || i)) {
            for (l = (a = w.map(ft(s, "script"), It)).length; h < d; h++)
                c = s,
                h !== f && (c = w.clone(c, !0, !0),
    ...
    w.extend({
        ...
        clone: function(t, e, n) {
            var i, s, o, r, a, l, c, u = t.cloneNode(!0), h = w.contains(t.ownerDocument, t);
            ...
            if (e)
                if (n)
                    ...
                    Pt(t, u);
            return (r = ft(u, "script")).length > 0 && pt(r, !h && ft(t, "script")),
            u
        },
    ...
    function Rt(t, e, n) {
        ...
        return (n = n || Yt(t)) && ("" !== (r = n.getPropertyValue(e) || n[e]) || w.contains(t.ownerDocument, t) || (r = w.style(t, e)),
        !p.pixelBoxStyles() && Ht.test(r) && $t.test(e) && (i = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    !function() {
        function e() {
            if (u) {
                ...
                _t.appendChild(c).appendChild(u);
        ...
        var s, o, r, a, l, c = i.createElement("div"), u = i.createElement("div");
    ...
    w.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, o, r, a = G(e), l = Ft.test(e), c = t.style;
                if (l || (e = zt(a)),
    ...
    w.each(["height", "width"], function(t, e) {
        w.cssHooks[e] = {
            get: function(t, n, i) {
                if (n)
                    return !qt.test(w.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? Zt(t, e, i) : ot(t, Ut, function() {
                        return Zt(t, e, i)
                    })
            },
            set: function(t, n, i) {
                var s, o = Yt(t), r = "border-box" === w.css(t, "boxSizing", !1, o), a = i && Qt(t, e, i, r, o);
    ...
    function ce(t, e, n) {
        ...
        for (!function(t, e) {
            ...
            if (i = ce.prefilters[o].call(c, t, u, c.opts))
    ...
    w.Animation = w.extend(ce, {
        ...
        prefilters: [function(t, e, n) {
            var i, s, o, r, a, l, c, u, h = "width"in e || "height"in e, d = this, f = {}, p = t.style, m = t.nodeType && st(t), g = Q.get(t, "fxshow");
    ...
    w.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? w.prop(t, e, n) : (1 === o && w.isXMLDoc(t) || (s = w.attrHooks[e.toLowerCase()] || (w.expr.match.bool.test(e) ? ue : void 0)),
    ...
    w.extend(w.event, {
        trigger: function(e, n, s, o) {
            var r, a, l, c, u, d, f, p, v = [s || i], y = h.call(e, "type") ? e.type : e, _ = h.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = p = l = s = s || i,
            3 !== s.nodeType && 8 !== s.nodeType && !ye.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (y = (_ = y.split(".")).shift(),
            _.sort()),
            u = y.indexOf(":") < 0 && "on" + y,
            ...
            o || !f.trigger || !1 !== f.trigger.apply(s, n))) {
                ...
                return e.type = y,
                o || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !z(s) || u && m(s[y]) && !g(s) && ((l = s[u]) && (s[u] = null),
                w.event.triggered = y,
    ...
    function Te(t, e, n, i) {
        ...
        if (Array.isArray(e))
            w.each(e, function(e, s) {
                n || xe.test(t) ? i(t, s) : Te(t + "[" + ("object" == typeof s && null != s ? e : "") + "]", s, n, i)
            });
    ...
    w.extend({
        ...
        ajax: function(e, n) {
            ...
            e = void 0),
            n = n || {};
            var s, o, r, a, l, c, u, h, d, f, p = w.ajaxSetup({}, n), m = p.context || p, g = p.context && (m.nodeType || m.jquery) ? w(m) : w.event, v = w.Deferred(), y = w.Callbacks("once memory"), _ = p.statusCode || {}, b = {}, D = {}, x = "canceled", k = {
                readyState: 0,
                ...
                setRequestHeader: function(t, e) {
                    return null == u && (t = D[t.toLowerCase()] = D[t.toLowerCase()] || t,
                    b[t] = e),
                    this
                },
            ...
            if (v.promise(k),
            p.url = ((e || p.url || be.href) + "").replace(Ne, be.protocol + "//"),
            ...
            u)
                return k;
            for (d in (h = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
            ...
            delete p.data),
            !1 === p.cache && (o = o.replace(Me, "$1"),
            f = (De.test(o) ? "&" : "?") + "_=" + we++ + f),
            p.url = o + f),
            p.ifModified && (w.lastModified[o] && k.setRequestHeader("If-Modified-Since", w.lastModified[o]),
            ...
            k.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + je + "; q=0.01" : "") : p.accepts["*"]),
            p.headers)
            ...
            function C(e, n, i, a) {
                ...
                c ? (p.ifModified && ((D = k.getResponseHeader("Last-Modified")) && (w.lastModified[o] = D),
                (D = k.getResponseHeader("etag")) && (w.etag[o] = D)),
                ...
                k.status = e,
                k.statusText = (n || x) + "",
                c ? v.resolveWith(m, [d, x, k]) : v.rejectWith(m, [k, x, f]),
                k.statusCode(_),
                _ = void 0,
                h && g.trigger(c ? "ajaxSuccess" : "ajaxError", [k, p, c ? d : f]),
                y.fireWith(m, [k, x]),
                h && (g.trigger("ajaxComplete", [k, p]),
    ...
    w.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
            ...
            a ? e[a] = e[a].replace(Be, "$1" + s) : !1 !== e.jsonp && (e.url += (De.test(e.url) ? "&" : "?") + e.jsonp + "=" + s),
    ...
    w.offset = {
        setOffset: function(t, e, n) {
            var i, s, o, r, a, l, c = w.css(t, "position"), u = w(t), h = {};
            "static" === c && (t.style.position = "relative"),
            a = u.offset(),
            o = w.css(t, "top"),
            l = w.css(t, "left"),
            ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1 ? (r = (i = u.position()).top,
...
function(t, e) {
    ...
    var v = "button"
      ...
      , O = function() {
        ...
        return n.toggle = function() {
            var t = !0
              , n = !0
              , i = e(this._element).closest(S)[0];
            if (i) {
                var s = this._element.querySelector(T);
                if (s) {
                    if ("radio" === s.type)
    ...
    e(document).on(M.CLICK_DATA_API, C, function(t) {
        t.preventDefault();
        var n = t.target;
        e(n).hasClass(x) || (n = e(n).closest(A)),
        O._jQueryInterface.call(e(n), "toggle")
    }).on(M.FOCUS_BLUR_DATA_API, C, function(t) {
        var n = e(t.target).closest(A)[0];
        e(n).toggleClass(k, /^focus(in)?$/.test(t.type))
    }),
    ...
    var I = "carousel"
      ...
      , tt = function() {
        ...
        n._slide = function(t, n) {
            var i, s, o, r = this, l = this._element.querySelector(X.ACTIVE_ITEM), c = this._getItemIndex(l), u = n || l && this._getItemByDirection(t, l), h = this._getItemIndex(u), d = Boolean(this._interval);
            if (t === $ ? (i = z,
            s = K,
            o = W) : (i = G,
            s = Q,
            ...
            u && e(u).hasClass(B))
                ...
                if (e(this._element).hasClass(V)) {
                    ...
                    e(l).one(a.TRANSITION_END, function() {
                        e(u).removeClass(i + " " + s).addClass(B),
                        e(l).removeClass(B + " " + s + " " + i),
                        r._isSliding = !1,
                        setTimeout(function() {
        ...
        n.show = function() {
            ...
            !(n && (i = e(n).not(this._selector).data(nt)) && i._isTransitioning))) {
                ...
                !o.isDefaultPrevented()) {
                    ...
                    e(this._element).removeClass(ct).addClass(ut),
                    this._element.style[r] = 0,
                    this._triggerArray.length && e(this._triggerArray).removeClass(ht).attr("aria-expanded", !0),
                    this.setTransitioning(!0);
                    var l = "scroll" + (r[0].toUpperCase() + r.slice(1))
                      , c = a.getTransitionDurationFromElement(this._element);
                    e(this._element).one(a.TRANSITION_END, function() {
                        e(s._element).removeClass(ut).addClass(ct).addClass(lt),
                        s._element.style[r] = "",
        ...
        n.hide = function() {
            ...
            if (!this._isTransitioning && e(this._element).hasClass(lt)) {
                ...
                !n.isDefaultPrevented()) {
                    ...
                    e(this._element).addClass(ut).removeClass(ct).removeClass(lt);
                    ...
                    if (s > 0)
                        for (var o = 0; o < s; o++) {
                            ...
                            if (null !== l)
                                e([].slice.call(document.querySelectorAll(l))).hasClass(lt) || e(r).addClass(ht).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    e(this._element).one(a.TRANSITION_END, function() {
                        ...
                        e(t._element).removeClass(ut).addClass(ct).trigger(at.HIDDEN)
                    }).emulateTransitionEnd(c)
                }
            }
        }
    ...
    ;
    for (var gt = "undefined" != typeof window && "undefined" != typeof document, vt = ["Edge", "Trident", "Firefox"], yt = 0, _t = 0; _t < vt.length; _t += 1)
        if (gt && navigator.userAgent.indexOf(vt[_t]) >= 0) {
            yt = 1;
            break
        }
    ...
    function kt(t) {
        ...
        var e = Dt(t)
          ...
          , i = e.overflowX
          , s = e.overflowY;
        return /(auto|scroll|overlay)/.test(n + s + i) ? t : kt(xt(t))
    }
    var Ct = gt && !(!window.MSInputMethodContext || !document.documentMode)
      , St = gt && /MSIE 10/.test(navigator.userAgent);
    function Tt(t) {
        return 11 === t ? Ct : 10 === t ? St : Ct || St
    }
    function Et(t) {
        if (!t)
    ...
    function Mt(t, e) {
        ...
        var c = At(t);
        return c.host ? Mt(c.host, e) : Mt(t, At(e).host)
    }
    function Ot(t) {
    ...
    function Ft(t, e, n, i) {
        ...
        if ("viewport" === i)
            ...
            var a = void 0;
            "scrollParent" === i ? "BODY" === (a = kt(xt(e))).nodeName && (a = t.ownerDocument.documentElement) : a = "window" === i ? t.ownerDocument.documentElement : i;
            var l = Wt(a, r, s);
            if ("HTML" !== a.nodeName || function t(e) {
                var n = e.nodeName;
                return "BODY" !== n && "HTML" !== n && ("fixed" === Dt(e, "position") || t(xt(e)))
            }(r))
                o = l;
            else {
    ...
    var he = {
        ...
        modifiers: {
                ...
                fn: function(t) {
                    ...
                    if (i) {
                        var s = t.offsets
                          ...
                          , u = {
                            start: Ht({}, l, o[l]),
                            end: Ht({}, l, o[l] + o[c] - r[c])
                        };
                        t.offsets.popper = Yt({}, r, u[i])
                    }
                    return t
                }
            },
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    var s = t.placement.split("-")[0]
                      ...
                      , f = l ? "bottom" : "right"
                      , p = Vt(i)[c];
                    a[f] - p < r[h] && (t.offsets.popper[h] -= r[h] - (a[f] - p)),
                    a[h] + p > r[f] && (t.offsets.popper[h] += a[h] + p - r[f]),
                    ...
                    return _ = Math.max(Math.min(r[c] - p, _), 0),
                    t.arrowElement = i,
                    t.offsets.arrow = (Ht(n = {}, h, Math.round(_)),
                    Ht(n, d, ""),
                    n),
                    t
                },
            ...
            flip: {
                ...
                fn: function(t, e) {
                    ...
                    return r.forEach(function(a, l) {
                        ...
                        i = t.placement.split("-")[0],
                        s = Gt(i);
                        var c, u = t.offsets.popper, h = t.offsets.reference, d = Math.floor, f = "left" === i && d(u.right) > d(h.left) || "right" === i && d(u.left) < d(h.right) || "top" === i && d(u.bottom) > d(h.top) || "bottom" === i && d(u.top) < d(h.bottom), p = d(u.left) < d(n.left), m = d(u.right) > d(n.right), g = d(u.top) < d(n.top), v = d(u.bottom) > d(n.bottom), y = "left" === i && p || "right" === i && m || "top" === i && g || "bottom" === i && v, _ = -1 !== ["top", "bottom"].indexOf(i), b = !!e.flipVariations && (_ && "start" === o && p || _ && "end" === o && m || !_ && "start" === o && g || !_ && "end" === o && v);
                        (f || y || b) && (t.flipped = !0,
                        (f || y) && (i = r[l + 1]),
                        b && (o = "end" === (c = o) ? "start" : "start" === c ? "end" : c),
                        t.placement = i + (o ? "-" + o : ""),
                        t.offsets.popper = Yt({}, t.offsets.popper, zt(t.instance.popper, t.offsets.reference, t.placement)),
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r, a, l, c, u, h, d, f, p, m, g, v, y = void 0 !== o ? o : e.gpuAcceleration, _ = Et(t.instance.popper), b = Rt(_), w = {
                        position: s.position
                    }, D = (r = t,
                    ...
                    c = l.popper,
                    u = l.reference,
                    h = -1 !== ["left", "right"].indexOf(r.placement),
                    d = -1 !== r.placement.indexOf("-"),
                    ...
                    ,
                    g = a ? h || d || f ? Math.round : Math.floor : m,
                    v = a ? Math.round : m,
                    {
                        left: g(p && !d && a ? c.left - 1 : c.left),
                        top: v(c.top),
                        bottom: v(c.bottom),
                        right: g(c.right)
                    }), x = "bottom" === n ? "top" : "bottom", k = "right" === i ? "left" : "right", C = Xt("transform"), S = void 0, T = void 0;
                    if (T = "bottom" === x ? "HTML" === _.nodeName ? -_.clientHeight + D.bottom : -b.height + D.bottom : D.top,
                    S = "right" === k ? "HTML" === _.nodeName ? -_.clientWidth + D.right : -b.width + D.right : D.left,
                    y && C)
                        w[C] = "translate3d(" + S + "px, " + T + "px, 0)",
                        w[x] = 0,
                        w[k] = 0,
                    ...
                    return t.attributes = Yt({}, M, t.attributes),
                    t.styles = Yt({}, w, t.styles),
            ...
            applyStyle: {
                ...
                onLoad: function(t, e, n, i, s) {
                    var o = Bt(s, e, t, n.positionFixed)
                      , r = Ut(n.placement, o, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
      ...
      , de = function() {
        function t(e, n) {
            ...
            Object.keys(Yt({}, t.Defaults.modifiers, s.modifiers)).forEach(function(e) {
                i.options.modifiers[e] = Yt({}, t.Defaults.modifiers[e] || {}, s.modifiers ? s.modifiers[e] : {})
            }),
            ...
            value: function() {
                return function() {
                    if (!this.state.isDestroyed) {
                        ...
                        t.offsets.reference = Bt(this.state, this.popper, this.reference, this.options.positionFixed),
    ...
    var fe = "dropdown"
      ...
      , Re = function() {
        ...
        var n = t.prototype;
        return n.toggle = function() {
            if (!this._element.disabled && !e(this._element).hasClass(be)) {
                ...
                !i) {
                    ...
                    !o.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && e(n).addClass(Se),
                            this._popper = new de(r,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === e(n).closest(Me).length && e(document.body).children().on("mouseover", null, e.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        e(this._menu).toggleClass(we),
                        e(n).toggleClass(we).trigger(e.Event(_e.SHOWN, s))
                    }
                }
            }
        }
        ,
        n.show = function() {
            if (!(this._element.disabled || e(this._element).hasClass(be) || e(this._menu).hasClass(we))) {
                var n = {
                    relatedTarget: this._element
                }
                  , i = e.Event(_e.SHOW, n)
                ...
                e(s).toggleClass(we).trigger(e.Event(_e.SHOWN, n)))
            }
        }
        ,
        n.hide = function() {
            if (!this._element.disabled && !e(this._element).hasClass(be) && e(this._menu).hasClass(we)) {
                ...
                e(s).trigger(i),
                i.isDefaultPrevented() || (e(this._menu).toggleClass(we),
                e(s).toggleClass(we).trigger(e.Event(_e.HIDDEN, n)))
            }
        }
        ,
        n.dispose = function() {
        ...
        n._addEventListeners = function() {
            var t = this;
            e(this._element).on(_e.CLICK, function(e) {
                e.preventDefault(),
                e.stopPropagation(),
                t.toggle()
            })
        ...
        n._getPlacement = function() {
            ...
            e(this._menu).hasClass(Ce) && (n = Ne)) : t.hasClass(xe) ? n = je : t.hasClass(ke) ? n = He : e(this._menu).hasClass(Ce) && (n = Le),
            n
        }
        ,
        ...
        t._clearMenus = function(n) {
            if (!n || 3 !== n.which && ("keyup" !== n.type || 9 === n.which))
                for (var i = [].slice.call(document.querySelectorAll(Te)), s = 0, o = i.length; s < o; s++) {
                    ...
                    a) {
                        ...
                        if (e(r).hasClass(we) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && e.contains(r, n.target))) {
                            ...
                            e(c).removeClass(we),
                            e(r).removeClass(we).trigger(e.Event(_e.HIDDEN, l)))
                        }
                    }
                }
        }
        ...
        t._dataApiKeydownHandler = function(n) {
            if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || e(n.target).closest(Ae).length)) : ye.test(n.which)) && (n.preventDefault(),
            n.stopPropagation(),
            !this.disabled && !e(this).hasClass(be))) {
    ...
    e(document).on(_e.KEYDOWN_DATA_API, Te, Re._dataApiKeydownHandler).on(_e.KEYDOWN_DATA_API, Ae, Re._dataApiKeydownHandler).on(_e.CLICK_DATA_API + " " + _e.KEYUP_DATA_API, Re._clearMenus).on(_e.CLICK_DATA_API, Te, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        Re._jQueryInterface.call(e(this), "toggle")
    }).on(_e.CLICK_DATA_API, Ee, function(t) {
        t.stopPropagation()
    }),
      ...
      , tn = function() {
        ...
        n.show = function(t) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                e(this._element).on(Ge.CLICK_DISMISS, Je.DATA_DISMISS, function(t) {
                    return n.hide(t)
                }),
                e(this._dialog).on(Ge.MOUSEDOWN_DISMISS, function() {
                    e(n._element).one(Ge.MOUSEUP_DISMISS, function(t) {
        ...
        n.hide = function(t) {
            ...
            this._isShown && !this._isTransitioning) {
                var i = e.Event(Ge.HIDE);
                if (e(this._element).trigger(i),
                this._isShown && !i.isDefaultPrevented()) {
                    this._isShown = !1;
                    var s = e(this._element).hasClass(Ze);
                    if (s && (this._isTransitioning = !0),
                    this._setEscapeEvent(),
                    this._setResizeEvent(),
                    e(document).off(Ge.FOCUSIN),
                    e(this._element).removeClass(Xe),
                    e(this._element).off(Ge.CLICK_DISMISS),
                    e(this._dialog).off(Ge.MOUSEDOWN_DISMISS),
                    s) {
        ...
        n._showElement = function(t) {
            ...
            e(this._element).addClass(Xe),
            this._config.focus && this._enforceFocus();
            var s = e.Event(Ge.SHOWN, {
                relatedTarget: t
            })
              , o = function() {
        ...
        n._enforceFocus = function() {
            var t = this;
            e(document).off(Ge.FOCUSIN).on(Ge.FOCUSIN, function(n) {
        ...
        n._setEscapeEvent = function() {
            var t = this;
            this._isShown && this._config.keyboard ? e(this._element).on(Ge.KEYDOWN_DISMISS, function(e) {
                27 === e.which && (e.preventDefault(),
                t.hide())
            }) : this._isShown || e(this._element).off(Ge.KEYDOWN_DISMISS)
        }
        ,
        n._setResizeEvent = function() {
            var t = this;
            this._isShown ? e(window).on(Ge.RESIZE, function(e) {
                return t.handleUpdate(e)
            }) : e(window).off(Ge.RESIZE)
        }
        ,
        n._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                e(document.body).removeClass(Qe),
                t._resetAdjustments(),
                t._resetScrollbar(),
                e(t._element).trigger(Ge.HIDDEN)
            })
        }
        ,
        ...
        n._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                e(this._element).on(Ge.CLICK_DISMISS, function(t) {
                    n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === n._config.backdrop ? n._element.focus() : n.hide())
                }),
                i && a.reflow(this._backdrop),
                e(this._backdrop).addClass(Xe),
                !t)
                    return;
                if (!i)
                    return void t();
        ...
        n._setScrollbar = function() {
            ...
            e(document.body).addClass(Qe)
        }
        ,
        n._resetScrollbar = function() {
            var t = [].slice.call(document.querySelectorAll(Je.FIXED_CONTENT));
        ...
        t._jQueryInterface = function(n, i) {
            return this.each(function() {
                var o = e(this).data(qe)
                  , r = s({}, Be, e(this).data(), "object" == typeof n && n ? n : {});
                if (o || (o = new t(this,r),
                e(this).data(qe, o)),
                "string" == typeof n) {
                    if (void 0 === o[n])
    ...
    e(document).on(Ge.CLICK_DATA_API, Je.DATA_TOGGLE, function(t) {
        var n, i = this, o = a.getSelectorFromElement(this);
        o && (n = document.querySelector(o));
        var r = e(n).data(qe) ? "toggle" : s({}, e(n).data(), e(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var l = e(n).one(Ge.SHOW, function(t) {
            t.isDefaultPrevented() || l.one(Ge.HIDDEN, function() {
                e(i).is(":visible") && i.focus()
            })
        });
        tn._jQueryInterface.call(e(n), r, this)
    }),
    e.fn[We] = tn._jQueryInterface,
    e.fn[We].Constructor = tn,
      ...
      , Dn = function() {
        ...
        n.toggle = function(t) {
            if (this._isEnabled)
                if (t) {
                    ...
                    if (e(this.getTipElement()).hasClass(mn))
        ...
        n.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && e(o).addClass(pn);
                ...
                var h = function() {
                    ...
                    n === dn && t._leave(null, t)
                };
                if (e(this.tip).hasClass(pn)) {
        ...
        n.addAttachmentClass = function(t) {
            e(this.getTipElement()).addClass(rn + "-" + t)
        }
        ,
        ...
        n.setContent = function() {
            ...
            this.setElementContent(e(t.querySelectorAll(gn)), this.getTitle()),
            e(t).removeClass(pn + " " + mn)
        }
        ,
        ...
        n._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(n) {
                if ("click" === n)
                    ...
                    var i = n === yn ? t.constructor.Event.MOUSEENTER : t.constructor.Event.FOCUSIN
                      , s = n === yn ? t.constructor.Event.MOUSELEAVE : t.constructor.Event.FOCUSOUT;
        ...
        n._enter = function(t, n) {
            ...
            t && (n._activeTrigger["focusin" === t.type ? _n : yn] = !0),
            e(n.getTipElement()).hasClass(mn) || n._hoverState === hn ? n._hoverState = hn : (clearTimeout(n._timeout),
            n._hoverState = hn,
            n.config.delay && n.config.delay.show ? n._timeout = setTimeout(function() {
                n._hoverState === hn && n.show()
        ...
        n._leave = function(t, n) {
            ...
            (n = n || e(t.currentTarget).data(i)) || (n = new this.constructor(t.currentTarget,this._getDelegateConfig()),
            e(t.currentTarget).data(i, n)),
            t && (n._activeTrigger["focusout" === t.type ? _n : yn] = !1),
            n._isWithActiveTrigger() || (clearTimeout(n._timeout),
            n._hoverState = dn,
            n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function() {
                n._hoverState === dn && n.hide()
        ...
        ,
        n._getConfig = function(t) {
            return "number" == typeof (t = s({}, this.constructor.Default, e(this.element).data(), "object" == typeof t && t ? t : {})).delay && (t.delay = {
                show: t.delay,
                hide: t.delay
            }),
            "number" == typeof t.title && (t.title = t.title.toString()),
            "number" == typeof t.content && (t.content = t.content.toString()),
            a.typeCheckConfig(en, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        n._fixTransition = function() {
            ...
            null === t.getAttribute("x-placement") && (e(t).removeClass(pn),
    ...
    e.fn[en] = Dn._jQueryInterface,
    e.fn[en].Constructor = Dn,
    ...
    var xn = "popover"
      ...
      , jn = function(t) {
        ...
        r.setContent = function() {
            ...
            this.setElementContent(t.find(Pn), n),
            t.removeClass(On + " " + In)
        }
        ,
        ...
        r._cleanTipClass = function() {
            var t = e(this.getTipElement())
              , n = t.attr("class").match(En);
            null !== n && n.length > 0 && t.removeClass(n.join(""))
        }
        ,
        o._jQueryInterface = function(t) {
            return this.each(function() {
                var n = e(this).data(kn)
    ...
    e.fn[xn] = jn._jQueryInterface,
    e.fn[xn].Constructor = jn,
    ...
    var Hn = "scrollspy"
      ...
      , Kn = function() {
        function t(t, n) {
            ...
            this._selector = this._config.target + " " + Vn.NAV_LINKS + "," + this._config.target + " " + Vn.LIST_ITEMS + "," + this._config.target + " " + Vn.DROPDOWN_ITEMS,
            this._offsets = [],
            this._targets = [],
            this._activeTarget = null,
            this._scrollHeight = 0,
            e(this._scrollElement).on(Fn.SCROLL, function(t) {
                return i._process(t)
            }),
            this.refresh(),
            this._process()
        ...
        return n.refresh = function() {
            var t = this
              , n = this._scrollElement === this._scrollElement.window ? Gn : zn
              , i = "auto" === this._config.method ? n : this._config.method
              , s = i === zn ? this._getScrollTop() : 0;
            this._offsets = [],
            this._targets = [],
        ...
        ,
        n._getConfig = function(t) {
            if ("string" != typeof (t = s({}, Wn, "object" == typeof t && t ? t : {})).target) {
                var n = e(t.target).attr("id");
                n || (n = a.getUID(Hn),
                e(t.target).attr("id", n)),
                t.target = "#" + n
            }
            return a.typeCheckConfig(Hn, t, qn),
            t
        }
        ,
        ...
        n._activate = function(t) {
            ...
            i.hasClass(Un) ? (i.closest(Vn.DROPDOWN).find(Vn.DROPDOWN_TOGGLE).addClass(Bn),
            i.addClass(Bn)) : (i.addClass(Bn),
            i.parents(Vn.NAV_LIST_GROUP).prev(Vn.NAV_LINKS + ", " + Vn.LIST_ITEMS).addClass(Bn),
            i.parents(Vn.NAV_LIST_GROUP).prev(Vn.NAV_ITEMS).children(Vn.NAV_LINKS).addClass(Bn)),
            e(this._scrollElement).trigger(Fn.ACTIVATE, {
                relatedTarget: t
            })
        }
        ,
    ...
    e(window).on(Fn.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll(Vn.DATA_SPY)), n = t.length; n--; ) {
            var i = e(t[n]);
            Kn._jQueryInterface.call(i, i.data())
        }
    }),
    e.fn[Hn] = Kn._jQueryInterface,
    e.fn[Hn].Constructor = Kn,
    e.fn[Hn].noConflict = function() {
        return e.fn[Hn] = Rn,
        Kn._jQueryInterface
    }
    ;
    var Qn = "bs.tab"
      ...
      , di = function() {
        ...
        return n.show = function() {
            var t = this;
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(ei) || e(this._element).hasClass(ni))) {
                var n, i, s = e(this._element).closest(ri)[0], o = a.getSelectorFromElement(this._element);
                if (s) {
                    var r = "UL" === s.nodeName || "OL" === s.nodeName ? li : ai;
                    i = (i = e.makeArray(e(s).find(r)))[i.length - 1]
                }
                var l = e.Event(Jn.HIDE, {
                    relatedTarget: this._element
                })
                  , c = e.Event(Jn.SHOW, {
                    relatedTarget: i
        ...
        ,
        n.dispose = function() {
            e.removeData(this._element, Qn),
            this._element = null
        }
        ,
        n._activate = function(t, n, i) {
            var s = this
              , o = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? e(n).children(ai) : e(n).find(li))[0]
              , r = i && o && e(o).hasClass(ii)
              , l = function() {
                return s._transitionComplete(t, o, i)
            };
            if (o && r) {
                var c = a.getTransitionDurationFromElement(o);
                e(o).removeClass(si).one(a.TRANSITION_END, l).emulateTransitionEnd(c)
            } else
                l()
        }
        ,
        n._transitionComplete = function(t, n, i) {
            if (n) {
                e(n).removeClass(ei);
                var s = e(n.parentNode).find(hi)[0];
                s && e(s).removeClass(ei),
            ...
            a.reflow(t),
            e(t).addClass(si),
            t.parentNode && e(t.parentNode).hasClass(ti)) {
                var o = e(t).closest(oi)[0];
                if (o) {
    ...
    e(document).on(Jn.CLICK_DATA_API, ci, function(t) {
        t.preventDefault(),
        di._jQueryInterface.call(e(this), "show")
    }),
    ...
    var fi = "toast"
      ...
      , Ci = function() {
        ...
        return n.show = function() {
            var t = this;
            e(this._element).trigger(vi.SHOW),
            this._config.animation && this._element.classList.add(yi);
            var n = function() {
                t._element.classList.remove(wi),
                t._element.classList.add(bi),
                e(t._element).trigger(vi.SHOWN),
                t._config.autohide && t.hide()
            };
            if (this._element.classList.remove(_i),
        ...
        n.hide = function(t) {
            var n = this;
            this._element.classList.contains(bi) && (e(this._element).trigger(vi.HIDE),
        ...
        n.dispose = function() {
            ...
            e(this._element).off(vi.CLICK_DISMISS),
        ...
        ,
        n._getConfig = function(t) {
            return t = s({}, xi, e(this._element).data(), "object" == typeof t && t ? t : {}),
        ...
        n._setListeners = function() {
            var t = this;
            e(this._element).on(vi.CLICK_DISMISS, ki, function() {
                return t.hide(!0)
            })
        }
        ,
        n._close = function() {
            var t = this
              , n = function() {
                t._element.classList.add(_i),
                e(t._element).trigger(vi.HIDDEN)
            };
            if (this._element.classList.remove(bi),
            this._config.animation) {
                var i = a.getTransitionDurationFromElement(this._element);
                e(this._element).one(a.TRANSITION_END, n).emulateTransitionEnd(i)
            } else
    ...
    e.fn[fi] = Ci._jQueryInterface,
    e.fn[fi].Constructor = Ci,
...
function(t, e) {
    ...
    function Wt(t, e, n, i, s) {
        ...
        return a <= 0 ? r = xt(o = t - 1) + a : a > xt(t) ? (o = t + 1,
        r = a - xt(t)) : (o = t,
        r = a),
        {
            year: o,
    ...
    q("hmmss", 0, 0, function() {
        return "" + Zt.apply(this) + H(this.minutes(), 2) + H(this.seconds(), 2)
    }),
    q("Hmm", 0, 0, function() {
    ...
    function ae(t, e) {
        var n;
        return t && (n = o(e) ? ce(t) : le(t, e)) && (te = n),
        te._abbr
    }
    function le(t, e) {
        if (null !== e) {
    ...
    function ce(t) {
        ...
        return function(t) {
            for (var e, n, i, s, o = 0; o < t.length; ) {
                for (e = (s = oe(t[o]).split("-")).length,
                n = (n = oe(t[o + 1])) ? n.split("-") : null; e > 0; ) {
                    if (i = re(s.slice(0, e).join("-")))
                        return i;
    ...
    function ue(t) {
        var e, n = t._a;
        return n && -2 === d(t).overflow && (e = n[mt] < 0 || n[mt] > 11 ? mt : n[gt] < 1 || n[gt] > Mt(n[pt], n[mt]) ? gt : n[vt] < 0 || n[vt] > 24 || 24 === n[vt] && (0 !== n[yt] || 0 !== n[_t] || 0 !== n[bt]) ? vt : n[yt] < 0 || n[yt] > 59 ? yt : n[_t] < 0 || n[_t] > 59 ? _t : n[bt] < 0 || n[bt] > 999 ? bt : -1,
        ...
        if (!t._d) {
            ...
            t._w && null == t._a[gt] && null == t._a[mt] && function(t) {
                ...
                if (null != (e = t._w).GG || null != e.W || null != e.E)
                    o = 1,
                    r = 4,
                    n = he(e.GG, t._a[pt], qt(Te(), 1, 4).year),
                    i = he(e.W, 1),
            ...
            null != t._dayOfYear && (r = he(t._a[pt], s[pt]),
            (t._dayOfYear > xt(r) || 0 === t._dayOfYear) && (d(t)._overflowDayOfYear = !0),
            ...
            24 === t._a[vt] && 0 === t._a[yt] && 0 === t._a[_t] && 0 === t._a[bt] && (t._nextDay = !0,
            t._a[vt] = 0),
    ...
    var fe = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/
      ...
      , ye = /^\/?Date\((\-?\d+)/i;
    function _e(t) {
        var e, n, i, s, o, r, a = t._i, l = fe.exec(a) || pe.exec(a);
        if (l) {
            for (d(t).iso = !0,
            e = 0,
            n = ge.length; e < n; e++)
    ...
    function xe(t) {
        var e, n, i, s = be.exec(t._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").trim());
        if (s) {
    ...
    function ke(t) {
        if (t._f !== n.ISO_8601)
            if (t._f !== n.RFC_2822) {
                t._a = [],
                d(t).empty = !0;
                var e, i, s, o, r, a, l, u, h = "" + t._i, f = h.length, p = 0;
                for (s = U(t._f, t._locale).match(Y) || [],
                e = 0; e < s.length; e++)
                    o = s[e],
                    (i = (h.match(ct(o, t)) || [])[0]) && ((r = h.substr(0, h.indexOf(i))).length > 0 && d(t).unusedInput.push(r),
                    h = h.slice(h.indexOf(i) + i.length),
                    p += i.length),
                    W[o] ? (i ? d(t).empty = !1 : d(t).unusedTokens.push(o),
                    a = o,
                    u = t,
                    null != (l = i) && c(ht, a) && ht[a](l, u._a, u, a)) : t._strict && !i && d(t).unusedTokens.push(o);
    ...
    function Ce(t) {
        ...
        _(v) ? new y(ue(v)) : (a(v) ? t._d = v : i(b) ? function(t) {
            ...
            for (s = 0; s < t._f.length; s++)
                ...
                n = e));
            u(t, n || e)
        }(t) : b ? ke(t) : o(c = (e = t)._i) ? e._d = new Date(n.now()) : a(c) ? e._d = new Date(c.valueOf()) : "string" == typeof c ? (h = e,
        null === (m = ye.exec(h._i)) ? (_e(h),
    ...
    function Ye(t, e) {
        ...
        s = (_(t) || a(t) ? t.valueOf() : Te(t).valueOf()) - i.valueOf(),
    ...
    function Fe(t, e) {
        ...
        e ? o[e] = t : o.milliseconds = t) : (a = We.exec(t)) ? (n = "-" === a[1] ? -1 : 1,
        o = {
            y: 0,
            d: w(a[gt]) * n,
            h: w(a[vt]) * n,
    ...
    function en(t, e, n, i, s) {
        var o;
        return null == t ? qt(this, i, s).year : (e > (o = Ft(t, i, s)) && (e = o),
        function(t, e, n, i, s) {
            var o = Wt(t, e, n, i, s)
    ...
    cn.calendar = function(t, e) {
        var i = t || Te()
          , s = Ye(i, this).startOf("day")
          , o = n.calendarFormat(this, s) || "sameElse"
          , r = e && (E(e[o]) ? e[o].call(this, i) : e[o]);
        return this.format(r || this.localeData().calendar(o, this, Te(i)))
    }
    ,
    cn.clone = function() {
        return new y(this)
    ...
    cn.from = function(t, e) {
        return this.isValid() && (_(t) && t.isValid() || Te(t).isValid()) ? Fe({
            to: this,
            from: t
    ...
    cn.utcOffset = function(t, e, i) {
        ...
        if (null != t) {
            ...
            return !this._isUTC && e && (s = $e(this)),
            this._offset = t,
            this._isUTC = !0,
            null != s && this.add(s, "m"),
            o !== t && (!e || this._changeInProgress ? Ge(this, Fe(t - o, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
            n.updateOffset(this, !0),
    ...
    cn.months = k("months accessor is deprecated. Use month instead", Lt),
    ...
    hn.monthsRegex = function(t) {
        return this._monthsParseExact ? (c(this, "_monthsRegex") || Yt.call(this),
        t ? this._monthsStrictRegex : this._monthsRegex) : (c(this, "_monthsRegex") || (this._monthsRegex = Ht),
    ...
    function Wn() {
        ...
        var t, e, n = $n(this._milliseconds) / 1e3, i = $n(this._days), s = $n(this._months);
        e = b((t = b(n / 60)) / 60),
        n %= 60,
        t %= 60;
        var o = b(s / 12)
        ...
        return d + "P" + (o ? f + o + "Y" : "") + (r ? f + r + "M" : "") + (a ? p + a + "D" : "") + (l || c || u ? "T" : "") + (l ? m + l + "H" : "") + (c ? m + c + "M" : "") + (u ? m + u + "S" : "")
    }
    var qn = Ie.prototype;
    ...
    qn.as = function(t) {
        ...
        if ("month" === (t = N(t)) || "year" === t)
            ...
            n = this._months + yn(e),
            "month" === t ? n : n / 12;
        switch (e = this._days + Math.round(_n(this._months)),
        t) {
        case "week":
            return e / 7 + i / 6048e5;
        case "day":
    ...
    qn._bubble = function() {
        ...
        return o >= 0 && r >= 0 && a >= 0 || o <= 0 && r <= 0 && a <= 0 || (o += 864e5 * vn(_n(a) + r),
        r = 0,
        a = 0),
    ...
    qn.humanize = function(t) {
        if (!this.isValid())
            return this.localeData().invalidDate();
        var e, n, i, s, o, r, a, l, c, u, h, d = this.localeData(), f = (n = !t,
        i = d,
        s = Fe(e = this).abs(),
        o = Hn(s.as("s")),
        r = Hn(s.as("m")),
        ...
        c = Hn(s.as("M")),
        u = Hn(s.as("y")),
        (h = o <= Yn.ss && ["s", o] || o < Yn.s && ["ss", o] || r <= 1 && ["m"] || r < Yn.m && ["mm", r] || a <= 1 && ["h"] || a < Yn.h && ["hh", a] || l <= 1 && ["d"] || l < Yn.d && ["dd", l] || c <= 1 && ["M"] || c < Yn.M && ["MM", c] || u <= 1 && ["y"] || ["yy", u])[2] = n,
        h[3] = +e > 0,
        h[4] = i,
        function(t, e, n, i, s) {
    ...
    n.relativeTimeRounding = function(t) {
        return void 0 === t ? Hn : "function" == typeof t && (Hn = t,
        !0)
    }
    ,
    n.relativeTimeThreshold = function(t, e) {
        return void 0 !== Yn[t] && (void 0 === e ? Yn[t] : (Yn[t] = e,
        "s" === t && (Yn.ss = e - 1),
        !0))
    }
    ,
...
function(e) {
    e.fn.extend({
        slimScroll: function(n) {
            ...
            return this.each(function() {
                var s, o, r, a, l, c, u, h, d = "<div></div>", f = 30, p = !1, m = e(this);
                if (m.parent().hasClass(i.wrapperClass)) {
                    ...
                    b = this,
                    window.addEventListener ? (b.addEventListener("DOMMouseScroll", k, !1),
                    b.addEventListener("mousewheel", k, !1)) : document.attachEvent("onmousewheel", k)
                }
                function k(t) {
                    if (s) {
                        var n = 0;
                        ...
                        e(o).closest("." + i.wrapperClass).is(m.parent()) && C(n, !0),
                ...
                function C(t, e, n) {
                    ...
                    s = (u = parseInt(D.css("top")) / (m.outerHeight() - D.outerHeight())) * (m[0].scrollHeight - m.outerHeight()),
                    n) {
...
function(t, e) {
    ...
    return n.prototype = {
        ...
        renderCalendar: function(n) {
            var i, s = (i = "left" == n ? this.leftCalendar : this.rightCalendar).month.month(), o = i.month.year(), r = i.month.hour(), a = i.month.minute(), l = i.month.second(), c = t([o, s]).daysInMonth(), u = t([o, s, 1]), h = t([o, s, c]), d = t(u).subtract(1, "month").month(), f = t(u).subtract(1, "month").year(), p = t([f, d]).daysInMonth(), m = u.day();
            (i = []).firstDay = u,
            i.lastDay = h;
            for (var g = 0; g < 6; g++)
                i[g] = [];
            ...
            for (var y = t([f, d, v, 12, a, l]), _ = (g = 0,
            0), b = 0; g < 42; g++,
            _++,
            y = t(y).add(24, "hour"))
                g > 0 && _ % 7 == 0 && (_ = 0,
                b++),
                i[b][_] = y.clone().hour(r).minute(a).second(l),
                y.hour(12),
                this.minDate && i[b][_].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && i[b][_].isBefore(this.minDate) && "left" == n && (i[b][_] = this.minDate.clone()),
                this.maxDate && i[b][_].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && i[b][_].isAfter(this.maxDate) && "right" == n && (i[b][_] = this.maxDate.clone());
            "left" == n ? this.leftCalendar.calendar = i : this.rightCalendar.calendar = i;
            var w = "left" == n ? this.minDate : this.startDate
              , D = this.maxDate
              , x = ("left" == n ? this.startDate : this.endDate,
            this.locale.direction,
            '<table class="table-condensed">');
            x += "<thead>",
            x += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (x += "<th></th>"),
            w && !w.isBefore(i.firstDay) || this.linkedCalendars && "left" != n ? x += "<th></th>" : x += '<th class="prev available"><span></span></th>';
            var k = this.locale.monthNames[i[1][1].month()] + i[1][1].format(" YYYY");
            if (this.showDropdowns) {
                for (var C = i[1][1].month(), S = i[1][1].year(), T = D && D.year() || this.maxYear, E = w && w.year() || this.minYear, A = S == E, M = S == T, O = '<select class="monthselect">', I = 0; I < 12; I++)
                    (!A || I >= w.month()) && (!M || I <= D.month()) ? O += "<option value='" + I + "'" + (I === C ? " selected='selected'" : "") + ">" + this.locale.monthNames[I] + "</option>" : O += "<option value='" + I + "'" + (I === C ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[I] + "</option>";
                O += "</select>";
                for (var N = '<select class="yearselect">', P = E; P <= T; P++)
                    N += '<option value="' + P + '"' + (P === S ? ' selected="selected"' : "") + ">" + P + "</option>";
                k = O + (N += "</select>")
            }
            if (x += '<th colspan="5" class="month">' + k + "</th>",
            D && !D.isAfter(i.lastDay) || this.linkedCalendars && "right" != n && !this.singleDatePicker ? x += "<th></th>" : x += '<th class="next available"><span></span></th>',
            x += "</tr>",
            x += "<tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) && (x += '<th class="week">' + this.locale.weekLabel + "</th>"),
            ...
            for (b = 0; b < 6; b++) {
                x += "<tr>",
                this.showWeekNumbers ? x += '<td class="week">' + i[b][0].week() + "</td>" : this.showISOWeekNumbers && (x += '<td class="week">' + i[b][0].isoWeek() + "</td>");
                for (_ = 0; _ < 7; _++) {
                    var j = [];
                    i[b][_].isSame(new Date, "day") && j.push("today"),
                    i[b][_].isoWeekday() > 5 && j.push("weekend"),
                    i[b][_].month() != i[1][1].month() && j.push("off"),
                    this.minDate && i[b][_].isBefore(this.minDate, "day") && j.push("off", "disabled"),
                    D && i[b][_].isAfter(D, "day") && j.push("off", "disabled"),
                    this.isInvalidDate(i[b][_]) && j.push("off", "disabled"),
                    i[b][_].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && j.push("active", "start-date"),
                    null != this.endDate && i[b][_].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && j.push("active", "end-date"),
                    null != this.endDate && i[b][_] > this.startDate && i[b][_] < this.endDate && j.push("in-range");
                    var H = this.isCustomDate(i[b][_]);
                    !1 !== H && ("string" == typeof H ? j.push(H) : Array.prototype.push.apply(j, H));
                    var Y = ""
                      , $ = !1;
                    for (g = 0; g < j.length; g++)
                        ...
                        "disabled" == j[g] && ($ = !0);
                    $ || (Y += "available"),
                    x += '<td class="' + Y.replace(/^\s+|\s+$/g, "") + '" data-title="r' + b + "c" + _ + '">' + i[b][_].date() + "</td>"
                }
                x += "</tr>"
            }
            x += "</tbody>",
            x += "</table>",
            this.container.find(".drp-calendar." + n + " .calendar-table").html(x)
        },
                ...
                this.endDate || this.container.find(".drp-calendar tbody td").each(function(t, n) {
                    if (!e(n).hasClass("week")) {
                        var i = e(n).attr("data-title")
                          , s = i.substr(1, 1)
                          , c = i.substr(3, 1)
                          , u = e(n).parents(".drp-calendar").hasClass("left") ? r.calendar[s][c] : a.calendar[s][c];
                        u.isAfter(l) && u.isBefore(o) || u.isSame(o, "day") ? e(n).addClass("in-range") : e(n).removeClass("in-range")
                    }
                })
            }
        },
...
function(t, e) {
    ...
    var n, i, s, o, r, a, l, c, u = function(t) {
        var e = "transitionend"
          , n = {
        ...
        i.show = function(t) {
            ...
            if (!this.transitioning && !n(t).hasClass(this.config.collapsingClass)) {
                ...
                !s.isDefaultPrevented()) {
                    ...
                    u.supportsTransitionEnd() ? i.height(t[0].scrollHeight).one(u.TRANSITION_END, o).mmEmulateTransitionEnd(350) : o()
                }
            }
        }
        ,
...
function(t) {
    ...
    var e = function() {
        ...
        function(t) {
            ...
            function o(t, e) {
                var n, i, s, o, r, a, l, c, u, h, d, f = e && e.split("/"), p = v.map, m = p && p["*"] || {};
                if (t) {
            ...
            var h, d, f, p, m = {}, g = {}, v = {}, y = {}, _ = Object.prototype.hasOwnProperty, b = [].slice, w = /\.js$/;
            f = function(t, e) {
        ...
        e.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(t, e, n, i, s, o, r, a, l, c, u, h, d, f, p, m, g, v, y, _, b, w, D, x, k, C, S, T, E) {
            ...
            return A.prototype.apply = function(h) {
                if (null == (h = t.extend(!0, {}, this.defaults, h)).dataAdapter) {
                    if (null != h.ajax ? h.dataAdapter = p : null != h.data ? h.dataAdapter = f : h.dataAdapter = d,
                    ...
                    h.maximumSelectionLength > 0 && (h.dataAdapter = c.Decorate(h.dataAdapter, _)),
                ...
                null != h.ajax && (h.resultsAdapter = c.Decorate(h.resultsAdapter, x)),
                null != h.placeholder && (h.resultsAdapter = c.Decorate(h.resultsAdapter, D)),
                ...
                if (null == h.selectionAdapter) {
                    ...
                    h.allowClear && (h.selectionAdapter = c.Decorate(h.selectionAdapter, r)),
                ...
                if (t.isArray(h.language)) {
                    ...
                    var $ = u.loadPath(this.defaults.amdLanguageBase + "en")
                      , R = new u(h.language);
                    R.extend($),
                    h.translations = R
                }
        ...
        var s = {
            ...
            calculateCaretPosition: function() {
                ...
                if (t !== n) {
                    ...
                    i = i - (u - c) - t,
                    s.maskDigitPosMap[i] && (i = r)) : i > r && (i = i + (c - u) + l)
                }
                return i
            },
            ...
            getMasked: function(t, e) {
                var o, a, l, c = [], u = void 0 === e ? s.val() : e + "", h = 0, d = n.length, f = 0, p = u.length, m = 1, g = "push", v = -1, y = 0, _ = [];
                ...
                a = function() {
                    ...
                    D.recursive && (-1 === v ? v = h : h === o && h !== v && (h = v - m),
                    o === v && (h -= m)),
                    h += m) : w === l ? (y--,
                    l = void 0) : D.optional ? (h += m,
                ...
                return u = n.charAt(o),
                d !== p + 1 || r.translation[u] || c.push(u),
                c = c.join(""),
                s.mapMaskdigitPositions(c, _, p),
                c
            },
...
function(t) {
    ...
    t.fn.TouchSpin = function(n) {
        ...
        return this.each(function() {
            var o, r, a, l, c, u, h, d, f, p, m = t(this), g = m.data(), v = 0, y = !1;
            function _() {
            ...
            function D() {
                b(),
                u = parseFloat(o.callback_before_calculation(c.input.val())),
                isNaN(u) && (u = 0);
                var t = u
                  , e = w();
                u += e,
                null !== o.max && u > o.max && (u = o.max,
            ...
            !function() {
                ...
                if (!m.data("alreadyinitialized"))
                    ...
                    m.on("keydown.touchspin", function(t) {
                        ...
                        38 === e ? ("up" !== y && (D(),
                        C()),
                        t.preventDefault()) : 40 === e && ("down" !== y && (x(),
                        k()),
                        t.preventDefault())
                    }),
        ...
        maxlength: function(e, n) {
            ...
            this.each(function() {
                function n() {
                    ...
                    h.mouseup(function() {
                        (h.outerWidth() !== h.data("maxlenghtsizex") || h.outerHeight() !== h.data("maxlenghtsizey")) && l(h, o),
                        h.data("maxlenghtsizex", h.outerWidth()),
                        h.data("maxlenghtsizey", h.outerHeight())
                    })),
                    e.appendToParent ? (h.parent().append(o),
                    h.parent().css("position", "relative")) : u.append(o),
                    a(s(h, c(h)), h, i, o),
                    l(h, o)
                }
                var i, o, h = t(this);
                ...
                h.on("input", function() {
                    var t, n, r, u, d = c(h), f = s(h, d), p = !0;
                    return e.validate && 0 > f ? (n = d,
                    r = (t = h).val(),
                    u = 0,
                    e.twoCharLinebreak && "\n" === (r = r.replace(/\r(?!\n)|\n(?!\r)/g, "\r\n")).substr(r.length - 1) && r.length % 2 == 1 && (u = 1),
                    t.val(r.substr(0, n - u)),
                    p = !1) : a(f, h, i, o),
                    ("bottom-right-inside" === e.placement || "top-right-inside" === e.placement) && l(h, o),
                    p
                })
            })
        }
