!function(r) {
  ...
  t.prototype.respChart=function(t, a, e, o) {
    let n=Chart.controllers.line.prototype.draw;
    Chart.controllers.line.prototype.draw=function() {
      n.apply(this, arguments);
      let r=this.chart.chart.ctx,
      t=r.stroke;
      r.stroke=function() {
        r.save(),
    ...
    ;
    let s=Chart.controllers.doughnut.prototype.draw;
    Chart.controllers.doughnut=Chart.controllers.doughnut.extend( {
      draw:function() {
        s.apply(this, arguments);
        let r=this.chart.chart.ctx, t=r.fill;
        r.fill=function() {
    ...
    let l=Chart.controllers.bar.prototype.draw;
  ...
  t.prototype.initCharts=function() {
    ...
    if(r("#revenue-chart").length>0) {
      t.push(this.respChart(r("#revenue-chart"), "Line", {
        labels:["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], datasets:[ {
          label: "Current Week", backgroundColor:"transparent", borderColor:"#727cf5", data:[32, 42, 42, 62, 52, 75, 62]
        }
        , {
          label: "Previous Week", fill:!0, backgroundColor:"transparent", borderColor:"#0acf97", data:[42, 58, 66, 93, 82, 105, 92]
        }
        ]
      }
      , {
        ...
        , tooltips: {
          backgroundColor: "#727cf5", titleFontColor:"#fff", bodyFontColor:"#fff", bodyFontSize:14, displayColors:!1
        }
        , hover: {
          intersect: !0
        }
        ...
        , scales: {
          xAxes:[ {
            ...
            , display:!0, borderDash:[5, 5], gridLines: {
              color: "rgba(0,0,0,0.01)", fontColor:"#fff"
            }
          }
          ]
        }
    ...
    if(r("#high-performing-product").length>0) {
      ...
      var e= {
        ...
        "Dec"],
        datasets:[ {
          label: "Sales Analytics", backgroundColor:a, borderColor:a, hoverBackgroundColor:a, hoverBorderColor:a, data:[65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81]
        }
        ,
        {
